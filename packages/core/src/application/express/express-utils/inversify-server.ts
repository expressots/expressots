...
import type { AuthProvider, BaseController, ConfigFunction, ControllerHandler, ControllerMethodMetadata, ExtractedParameters, HttpContext, Middleware, ParameterMetadata, Principal, RoutingConfig } from './interfaces';
  ...
  private handlerFactory(
    ...
    return async (
      ...
      try {
        ...
        const value = await (httpContext.container.getNamed<BaseController>(
          TYPE.Controller,
          controllerName,
