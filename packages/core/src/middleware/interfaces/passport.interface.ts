...
/**
 * Type definition for the Authenticate function.
 * @param passport - The Passport instance.
 * @param name - The name of the strategy to authenticate.
 * @param options - Optional options for authentication.
 * @param callback - Optional callback for handling authentication.
...
/**
 * Type definition for the callback used in authentication and authorization.
 * @param err - An error object, if an error occurred during authentication.
 * @param user - The authenticated user, if authentication was successful.
 * @param info - Additional information related to authentication.
 * @param status - HTTP status code or an array of status codes.
 * @returns The result of authentication or authorization.
 */
...
/**
 * Type definition for the callback used in authorization.
 * It has the same structure as AuthenticateCallback.
 */
...
interface RequestHandler {
    (req: any, res: any, next: any): void; // You may want to define more specific types
}
...
> {
     ...
     */
    authenticate(
        strategy: string | Array<string> | Strategy,
        callback?: AuthenticateCallback | ((...args: Array<any>) => any),
    ): AuthenticateRet;
    authenticate(
        strategy: string | Array<string> | Strategy,
        options: AuthenticateOptions,
     ...
     */
    authorize(strategy: string | Array<string>, callback?: AuthorizeCallback | ((...args: Array<any>) => any)): AuthorizeRet;
    authorize(
        strategy: string | Array<string>,
        options: AuthorizeOptions,
        callback?: AuthorizeCallback | ((...args: Array<any>) => any),
    ): AuthorizeRet;
    /**
...
declare global {
    namespace Express {
        ...
        interface Request {
            ...
            login(user: User, options: LogInOptions, done: (err: any) => void): void;
            /**
             * Initiate a login session for `user`.
             *
             * Options:
             ...
             */
            logout(options: LogOutOptions, done: (err: any) => void): void;
...
interface Framework<InitializeRet = any, AuthenticateRet = any, AuthorizeRet = AuthenticateRet> {
    ...
    ): (...args: Array<any>) => AuthenticateRet;
    /**
     * Create third-party service authorization middleware.
     *
     * Returns middleware that will authorize a connection to a third-party service.
...
/**
 * The `passportOptions` interface defines options for configuring Passport.
 */
export interface passportOptions {
    ...
    session?: SessionOptions,
     /**
     * Function used to serialize user objects into the session.
     * @param user - The user object to serialize.
     * @param done - The callback function to call when serialization is complete.
     */
    serializeUser?: (user: Express.User,
        done: (err: any, id?: number | NonNullable<unknown>) => void
    ) => void,
     /**
     * Function used to deserialize user objects out of the session.
     * @param id - The user ID to deserialize.
     * @param done - The callback function to call when deserialization is complete.
     */
    deserializeUser?: (
        id: any,
