...
namespace interfaces {
  ...
  export type SimpleFactory<T, U extends Array<unknown> = Array<unknown>> = (
    ...args: U
  ) => T;

  export type MultiFactory<
    T,
    U extends Array<unknown> = Array<unknown>,
    V extends Array<unknown> = Array<unknown>,
  ...
  export type Provider<T> = (
    ...args: Array<unknown>
  ) => ((...args: Array<unknown>) => Promise<T>) | Promise<T>;
  ...
  export interface Request {
    ...
    addChildRequest(
      serviceIdentifier: ServiceIdentifier,
      bindings: Binding<unknown> | Array<Binding<unknown>>,
      target: Target,
    ): Request;
  }
 ...
 */
  ...
  export interface BindingToSyntax<T> {
    ...
    toFactory<
      T2,
      T3 extends Array<unknown> = Array<unknown>,
      T4 extends Array<unknown> = Array<unknown>,
    >(
