...
export async function generateDockerCompose(
	...
	for (const env of environments) {
		...
		// Derive PM-aware vars from the project analysis so any
		// command/lockfile placeholders in the compose templates match
		// the detected package manager instead of assuming npm.
		const vars: DockerTemplateVars = buildDockerVars(
			analysis,
			"dist/src/main.js",
		);
