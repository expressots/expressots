 ...
 *
 * KEEP IN SYNC with the UI mirror at `packages/studio/ui/lib/resource-tags.ts`.
 * This is a pure, dependency-free module intentionally duplicated across the
 * agent/UI boundary (the same convention used for the `RouteInfo` type),
 * because the Vite-bundled UI does not import the agent package.
 */
