  ...
  return (
    <div className="space-y-3">
      ...
      <div
        ...
        className="relative h-[calc(100vh-260px)] bg-gray-900 rounded-lg border border-gray-800 overflow-hidden"
      >
        <ReactFlow
          nodes={nodesState}
          edges={edgesState}
        ...
        {copiedHint && (
          <div className="absolute top-4 left-1/2 -translate-x-1/2 bg-gray-950/95 border border-gray-700 px-3 py-1.5 rounded-md text-xs text-gray-200">
            {copiedHint}
          </div>
        )}

        {/* Legend */}
        <div className="absolute bottom-4 left-4 bg-gray-900/90 backdrop-blur-sm p-3 rounded-lg border border-gray-800">
...
function Toolbar(props: {
  ...
  return (
    <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-2.5 flex flex-wrap items-center gap-2">
      <div className="relative flex-1 min-w-[200px]">
        <input
          ...
          className="w-full pl-8 pr-2 py-1.5 rounded-md bg-gray-950 border border-gray-800 text-xs text-gray-200 focus:outline-none focus:border-primary-500"
        />
      ...
      <div className="relative">
        <button
          ...
          className="flex items-center gap-1 px-2 py-1.5 rounded-md bg-gray-900 border border-gray-800 text-xs text-gray-300 hover:border-primary-500"
        >
        ...
        {props.exportMenuOpen && (
          <div className="absolute right-0 top-full mt-1 z-10 w-48 bg-gray-950 border border-gray-800 rounded-md shadow-xl overflow-hidden">
            <ExportItem
...
function ExportItem({
  ...
  return (
    <button
      onClick={onClick}
      className="flex items-start gap-2 w-full px-3 py-2 text-left hover:bg-gray-900 transition-colors"
    >
...
function NodeDetailDrawer({
  ...
  return (
    <div className="absolute right-0 top-0 bottom-0 w-96 bg-gray-950/95 border-l border-gray-800 backdrop-blur-md p-4 overflow-y-auto">
      ...
      {node.stats && node.stats.req > 0 && (
        <div className="mb-3 p-2.5 rounded-md bg-gray-900/60 border border-gray-800">
        ...
        <div className="mb-3">
          ...
          <div className="flex flex-wrap gap-1">
            {node.methods.map((m) => (
              <span
                key={m}
                className="px-1.5 py-0.5 rounded text-[10px] font-mono bg-gray-900/60 border border-gray-800 text-gray-300"
              >
                {m}()
              </span>
            ))}
      ...
      {node.filePath && (
        <button
          ...
          className="w-full flex items-center justify-center gap-1.5 mt-2 py-1.5 rounded-md bg-gray-900 border border-gray-800 text-xs text-gray-300 hover:border-primary-500"
        >
