...
import { IUserDeleteRequestDTO, IUserDeleteResponseDTO } from "./user-delete.dto";
...
class UserDeleteController extends BaseController {
    ...
    execute(
        ...
        return this.callUseCase(this.userDeleteUseCase.execute(payload), res, StatusCode.OK);
    }
}
