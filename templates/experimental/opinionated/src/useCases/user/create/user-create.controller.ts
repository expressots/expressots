...
import { ICreateUserRequestDTO, ICreateUserResponseDTO } from "./user-create.dto";
...
class UserCreateController extends BaseController {
    ...
    execute(
        ...
        return this.callUseCase(this.createUserUseCase.execute(payload), res, StatusCode.Created);
    }
}
